...
/*   Updated: 2025/11/05 18:09:59 by thbouver         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	fake_bold(fdf, (t_vec2){TITLE_X, HEIGHT * 0.425},
		MAIN_COLOR, "PROJECTIONS");
	fake_bold(fdf, (t_vec2){CATEGORIE_X_MARGIN
...
{
	fake_bold(fdf, (t_vec2){TITLE_X, HEIGHT * 0.63},
		MAIN_COLOR, "CONTROLS");
	mlx_string_put(fdf->mlx, fdf->mlx_win, CATEGORIE_X_MARGIN, HEIGHT
